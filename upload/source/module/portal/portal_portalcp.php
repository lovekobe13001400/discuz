...
//echo libfile('function/portalcp');exit();//C:\wamp\www\discuz\upload\source\function\function_portalcp.php
require_once libfile('function/portalcp');
//echo libfile('portalcp/'.$ac, 'include');exit();//C:\wamp\www\discuz\upload\source\include\portalcp\portalcp_article.php
